...
const OnetimeLinks = () => {
	...
	const updateLogsStatus = () => {
		...
		dispatch({ type: 'UPDATE_ENABLE_ONETIME_LINKS', payload: assetStatus });
			...
			<div className='mr-16 w-full flex items-center'>
				...
				<Switch
					...
					className={classNames(
						enableOnetimeLinksStatus ? 'bg-lmn' : 'bg-slate-200',
				...
				>
					...
					<span
						aria-hidden="true"
						className={classNames(
							enableOnetimeLinksStatus ? 'bg-lmn' : 'bg-gray-200',
					...
					<span
						aria-hidden="true"
						className={classNames(
							enableOnetimeLinksStatus ? 'translate-x-5' : 'translate-x-0',
